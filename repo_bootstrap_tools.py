...
BOOTSTRAP_SYSTEM_PROMPT = (
    ...
    "  7. If you get lost, call current_goal to see the stack.\n\n"
    "VERIFY (must both pass since the last install_repo_editable):\n"
    "  8. run_sanity — verify the package imports.\n"
    "  9. run_smoke_test — verify pytest collects and one specific test passes.\n"
    " 10. declare_env_ready. The harness rejects this until 8 and 9 both "
