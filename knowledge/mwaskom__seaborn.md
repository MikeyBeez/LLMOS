# Knowledge: mwaskom/seaborn

Accumulated notes for working on `mwaskom/seaborn`. Loaded whenever this repo is the 
...
- Backend: uv
- Common installs: matplotlib, numpy, pandas, scipy
