...
def main():
    ...
    r.add_argument("--host", default="http://localhost:11434", help="ollama host URL")
    ...
    b.add_argument("--model", default="qwen2.5:latest")
    b.add_argument("--host", default="http://localhost:11434", help="ollama host URL")
